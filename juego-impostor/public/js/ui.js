...
function updateScoringText(isSiege) {
    ...
    if (isSiege) {
        ...
        desc.innerHTML = `<span style="color:#e74c3c">☠️ Alto riesgo</span> <small style="opacity:0.7">El impostor gana más puntos por adivinar la palabra secreta. Activar este modo si los ciudadanos ganan frecuentemente.</small>`;
    } else {
        // Texto para Modo Supervivencia
        desc.innerHTML = `<span style="color:#2ecc71">🥷 Supervivencia</span> <small style="opacity:0.7">El impostor gana más puntos por sobrevivir sin ser descubierto. Activar este modo si el impostor gana frecuentemente.</small>`;
    }
}
